...
--@callback         :换装成功回调
function SGUIObject:ChangeSkin(changeSkinPartName, skinModelName, callBack, boneConfigAddress)
    return self.m_Core:ChangeSkin(changeSkinPartName, skinModelName, callBack, boneConfigAddress)
end
