...
namespace ThorEngine.Core
{
    ...
    public static class GameObjectExt
    {
        ...
        public static Component GetOrAddComponent(this GameObject rGameObject, System.Type type)
        {
            var result = rGameObject.GetComponent(type);
            if (result == null) { result = rGameObject.AddComponent(type); }
